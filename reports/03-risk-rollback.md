...
|---|---|---|---|---|---|---|
| R1 | `git push --force origin gd5/rebase-fork-master:master` (Hyd) | 2026-09-04T13:50Z | Mất lịch sử commit PR #5 (3 commit GĐ4.5.1+4.5.2+4.5.3) | Backup: `git tag audit-fork-master-pre-rebase` (không tạo — phụ thuộc upstream `9f89728` làm ref) | Upstream master `9f89728` | `git fetch upstream && git reset --hard 9f89728 && git push --force origin master` |
...
- **Status**: Không rollback cần thiết — fork hiện sync với upstream + 0 commit mới (GD4.5.3 đã loại bỏ).
...
### Hyd fork
- **Master HEAD**: `9f89728` (= upstream master)
- **Branches**: 2 (master + gd5/final-fork-master với 4 commit GĐ4.5.1+4.5.2+GĐ5.5+GĐ5.9)
- **PRs**: 0 open (tất cả 7 closed)
